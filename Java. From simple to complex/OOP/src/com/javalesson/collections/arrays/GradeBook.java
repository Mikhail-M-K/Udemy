...
public class GradeBook {
    ...
    private static void varArgs() {
        ...
        System.out.println("Average of 2 elements is " + calcAwerage(a,b));
        System.out.println("Average of 2 elements is " + calcAwerage(a,b,c));
        System.out.println("Average of 2 elements is " + calcAwerage(a,b,c,d));

    }

    private static double calcAwerage (double...args) {
        double sum = 0;
        for (double i : args) {
            sum += i;
        }
